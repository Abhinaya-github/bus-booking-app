...
class Bus(models.Model):
    ...
    #creating afuntion to display theabout what should be displayed
    def __str__(self):
        return f"{self.bus_name} {self.number} {self.origin} {self.destination}"

#creating seat model also creating relation between seats and bus
